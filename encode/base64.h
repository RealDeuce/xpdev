 ...
 *
 * This header was rewritten for the standalone XPDev distribution and is
 * licensed under the same GNU Lesser General Public License terms as the
 * implementation.  It replaces an older header whose GPL notice was added
 * in error and did not reflect the license of base64.c or the XPDev library.
 */
